...
class BaseSnsClientException(Exception):
    pass


class BaseErrorResponse(BaseSnsClientException):
    message: str | None = (
        "Generic error response from SNS; a common cause is expired/invalid aws_session_token"
    )
